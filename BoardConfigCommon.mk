...
BOARD_KERNEL_CMDLINE := ttyHSL0,115200,n8 androidboot.console=ttyHSL0 user_debug=31 msm_rtb.filter=0x37 androidboot.hardware=e7 ignore_loglevel androidboot.bootdevice=msm_sdcc.1 androidboot.selinux=permissive
